...
Route::middleware('admin.auth')->group(function() {
    ...
    Route::controller(CompanyController::class)->group(function(){
        Route::match(['get','patch'],'companies', 'index')->name('companies.index')->middleware('can:browse_companies');
        Route::get('companies/create', 'create')->name('companies.create')->middleware('can:add_companies');
        Route::get('companies/{id}', 'show')->name('companies.show')->middleware('can:read_companies');
        Route::get('companies/{id}/edit', 'edit')->name('companies.edit')->middleware('can:edit_companies');
        Route::post('companies', 'store')->name('companies.store')->middleware('can:add_companies');
        Route::put('companies/{id}', 'update')->name('companies.update')->middleware('can:edit_companies');
        Route::delete('companies/{id}/delete', 'destroy')->name('companies.destroy')->middleware('can:delete_companies');
    });
