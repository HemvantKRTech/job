                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="{{ route('admin.dashboard.index') }}" class="logo logo-dark">
                        <span class="logo-sm">
                            ...
                            <img src="{{asset(get_app_setting('logo')??'admin-assets/images/logo.png')}}" alt="">
                        </span>
                        <span class="logo-lg">
                            <img src="{{asset(get_app_setting('logo')??'admin-assets/images/logo.png')}}" alt="">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{{asset(getAdmin('avatar')??'admin-assets/images/users/avatar.png')}}"
                                alt="{{getAdmin('full_name')}}">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{getAdmin('full_name')}}</span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome {{getAdmin('full_name')}}!</h6>
